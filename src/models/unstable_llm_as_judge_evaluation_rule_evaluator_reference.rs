...
/// UnstableLlmAsJudgeEvaluationRuleEvaluatorReference : LLM-as-judge evaluator family reference used when creating an evaluation rule.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize, bon::Builder)]
pub struct UnstableLlmAsJudgeEvaluationRuleEvaluatorReference {
