...
pub struct UnstableCreateSkillVersionRequest {
    #[serde(rename = "files")]
    pub files: Vec<models::UnstableSkillVersionFileCreateInput>,
    #[serde(
...
impl UnstableCreateSkillVersionRequest {
    pub fn new(
        files: Vec<models::UnstableSkillVersionFileCreateInput>,
