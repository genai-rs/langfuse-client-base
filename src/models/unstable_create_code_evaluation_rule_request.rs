...
pub struct UnstableCreateCodeEvaluationRuleRequest {
    /// Human-readable deployment name.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "evaluator")]
    pub evaluator: Box<models::UnstableCodeEvaluationRuleEvaluatorReference>,
    #[serde(rename = "target")]
...
impl UnstableCreateCodeEvaluationRuleRequest {
    pub fn new(
        name: String,
        evaluator: models::UnstableCodeEvaluationRuleEvaluatorReference,
