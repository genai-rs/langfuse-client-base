...
pub struct UnstableSkillFileContentResponse {
    #[serde(rename = "content")]
    pub content: String,
}

impl UnstableSkillFileContentResponse {
    pub fn new(content: String) -> UnstableSkillFileContentResponse {
        UnstableSkillFileContentResponse { content }
    }
}
