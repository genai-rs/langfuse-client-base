...
pub struct UnstableCreateDashboardPlacementRequestOneOf {
...
impl UnstableCreateDashboardPlacementRequestOneOf {
    pub fn new(widget_id: String, r#type: Type) -> UnstableCreateDashboardPlacementRequestOneOf {
