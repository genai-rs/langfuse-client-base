...
pub struct UnstableSkillVersionFileReference {
    #[serde(rename = "path")]
    pub path: String,
...
impl UnstableSkillVersionFileReference {
    pub fn new(path: String, sha256_hash: String) -> UnstableSkillVersionFileReference {
        UnstableSkillVersionFileReference { path, sha256_hash }
    }
}
