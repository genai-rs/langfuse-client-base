...
pub struct UnstableUpdateSkillLabelsRequest {
    #[serde(rename = "labels")]
    pub labels: Vec<String>,
}

impl UnstableUpdateSkillLabelsRequest {
    pub fn new(labels: Vec<String>) -> UnstableUpdateSkillLabelsRequest {
        UnstableUpdateSkillLabelsRequest { labels }
    }
}
