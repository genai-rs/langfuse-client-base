...
/// UnstableSkillVersionFileCreateInput : Provide exactly one of content or sha256Hash for each path.
/// Provide exactly one of content or sha256Hash for each path.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UnstableSkillVersionFileCreateInput {
    UnstableSkillVersionFileInput(Box<models::UnstableSkillVersionFileInput>),
    UnstableSkillVersionFileReference(Box<models::UnstableSkillVersionFileReference>),
}

impl Default for UnstableSkillVersionFileCreateInput {
    fn default() -> Self {
        Self::UnstableSkillVersionFileInput(Default::default())
    }
}
