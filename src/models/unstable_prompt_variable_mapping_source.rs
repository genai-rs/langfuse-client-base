...
impl std::fmt::Display for UnstablePromptVariableMappingSource {
...
impl Default for UnstablePromptVariableMappingSource {
    fn default() -> UnstablePromptVariableMappingSource {
        Self::Input
    }
}
