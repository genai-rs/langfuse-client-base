...
pub struct UnstableDeleteSkillVersionResponse {
    #[serde(rename = "deleted")]
    pub deleted: bool,
}

impl UnstableDeleteSkillVersionResponse {
    pub fn new(deleted: bool) -> UnstableDeleteSkillVersionResponse {
        UnstableDeleteSkillVersionResponse { deleted }
    }
}
