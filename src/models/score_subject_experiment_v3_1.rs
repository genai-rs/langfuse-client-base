...
pub struct ScoreSubjectExperimentV31 {
...
impl ScoreSubjectExperimentV31 {
    pub fn new(id: String, kind: Kind) -> ScoreSubjectExperimentV31 {
        ScoreSubjectExperimentV31 { id, kind }
    }
}
///
