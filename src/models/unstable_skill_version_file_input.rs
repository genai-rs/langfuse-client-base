...
pub struct UnstableSkillVersionFileInput {
    #[serde(rename = "path")]
    pub path: String,
...
impl UnstableSkillVersionFileInput {
    pub fn new(path: String, content: String) -> UnstableSkillVersionFileInput {
        UnstableSkillVersionFileInput { path, content }
    }
}
