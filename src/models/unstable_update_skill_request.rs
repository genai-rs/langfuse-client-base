...
pub struct UnstableUpdateSkillRequest {
    /// The complete set of tags to apply to every version of the skill. Pass an empty list to clear all tags.
    #[serde(rename = "tags")]
    pub tags: Vec<String>,
}

impl UnstableUpdateSkillRequest {
    pub fn new(tags: Vec<String>) -> UnstableUpdateSkillRequest {
        UnstableUpdateSkillRequest { tags }
    }
}
