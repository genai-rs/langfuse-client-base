...
pub struct UnstableSkillMetaListResponse {
    #[serde(rename = "data")]
    pub data: Vec<models::UnstableSkillMeta>,
    #[serde(rename = "meta")]
    pub meta: Box<models::UnstableSkillListPagination>,
}

impl UnstableSkillMetaListResponse {
    pub fn new(
        data: Vec<models::UnstableSkillMeta>,
        meta: models::UnstableSkillListPagination,
