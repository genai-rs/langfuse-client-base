...
## [0.15.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.14.0...v0.15.0) - 2026-09-26
...
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
- *(deps)* Update Rust crate serde_with to ^3.23.0
...
## [0.13.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.12.0...v0.13.0) - 2026-05-18
...
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
- *(deps)* Update openapitools/openapi-generator-cli Docker tag to v7.22.0
- update generated client from latest OpenAPI spec
...
- *(deps)* Update openapitools/openapi-generator-cli Docker tag to v7.21.0
- update generated client from latest OpenAPI spec
...
- normalize invalid float integer schema before generation
...
## [0.10.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.9.0...v0.10.0) - 2026-02-23

### Other

- *(deps)* Update Rust crate bon to 3.9.0
- *(deps)* Update openapitools/openapi-generator-cli Docker tag to v7.20.0
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec

## [0.9.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.8.0...v0.9.0) - 2026-02-09

### Fixed

- preserve curated Cargo.toml entries during generation merge

### Other

- update generated client from latest OpenAPI spec

## [0.8.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.7.1...v0.8.0) - 2026-02-09

### Other

- *(deps)* Update rust patch updates
- *(deps)* Update openapitools/openapi-generator-cli Docker tag to v7.19.0
- Fix reqwest 0.13 feature flags
- *(deps)* Update rust minor updates
- *(deps)* Update rust patch updates
...
- *(deps)* Update Rust crate serde_with to ^3.16.1
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
- *(deps)* Update actions/checkout action to v6

## [0.6.1](https://github.com/genai-rs/langfuse-client-base/compare/v0.6.0...v0.6.1) - 2025-11-18
...
- update generated client from latest OpenAPI spec
- update generated client from latest OpenAPI spec
- preserve per-section dependency versions (genai-a0b8)
- preserve deps during client generation (genai-a0b8)

## [0.6.0](https://github.com/genai-rs/langfuse-client-base/compare/v0.5.0...v0.6.0) - 2025-11-02
