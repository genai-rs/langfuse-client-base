...
------------ | ------------- | ------------- | -------------
**id** | **String** |  | 
**trace_id** | Option<**String**> | The trace ID associated with the score | [optional]
**session_id** | Option<**String**> | The session ID associated with the score | [optional]
...
**value** | **f64** | The numeric value of the score. Always 0 for correction scores. | 
**string_value** | **String** | The string representation of the correction content | 
**data_type** | **DataType** |  (enum: CORRECTION) | 
