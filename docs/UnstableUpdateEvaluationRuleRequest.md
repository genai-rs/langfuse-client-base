...
**mapping** | Option<[**Vec<models::UnstablePromptVariableMappingInput>**](UnstablePromptVariableMappingInput.md)> | Updated LLM-as-judge variable mappings.  Do not send this field for code evaluator rules. Langfuse stores the fixed code runtime mapping automatically and returns it in the response. | [optional]
