...
**data_type** | **String** | Numeric score output. | 
**min_value** | Option<**f64**> | Optional inclusive minimum value. | [optional]
**max_value** | Option<**f64**> | Optional inclusive maximum value. | [optional]
