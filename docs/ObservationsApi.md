...
> models::ObservationsV2Response observations_get_many(fields, expand_metadata, limit, cursor, parse_io_as_json, name, user_id, r#type, trace_id, level, parent_observation_id, environment, from_start_time, to_start_time, version, filter)
