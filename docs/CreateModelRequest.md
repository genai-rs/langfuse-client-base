...
**unit** | [**models::ModelUsageUnit**](ModelUsageUnit.md) |  | 
...
**tokenizer_id** | Option<[**models::ModelTokenizerId**](ModelTokenizerId.md)> |  | [optional]
**tokenizer_config** | Option<**serde_json::Value**> | Optional. Configuration for the selected tokenizer. Needs to be JSON. See docs for more details. | [optional]
