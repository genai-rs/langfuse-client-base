...
**resolution_graph** | Option<**std::collections::HashMap<String, serde_json::Value>**> | The dependency resolution graph for the current prompt. Null if prompt has no dependencies. | [optional]
