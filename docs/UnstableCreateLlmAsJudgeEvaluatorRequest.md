...
**mapping** | Option<[**Vec<models::UnstablePromptVariableMappingInput>**](UnstablePromptVariableMappingInput.md)> | Optional default variable mapping inherited by rule assignments that do not provide an override. | [optional]
