...
**config** | Option<**std::collections::HashMap<String, serde_json::Value>**> | Adapter-specific configuration. Required for Bedrock (`{\"region\":\"us-east-1\"}`), optional for OpenAI (`{\"useResponsesApi\":true}`), optional for VertexAI (`{\"location\":\"us-central1\"}`), not used by other adapters. | [optional]
