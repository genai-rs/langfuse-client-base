...
**config** | Option<[**std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md)> | Adapter-specific configuration. Required for Bedrock (`{\"region\":\"us-east-1\"}`), optional for VertexAI (`{\"location\":\"us-central1\"}`), not used by other adapters. | [optional]
**created_at** | **String** |  | 
**updated_at** | **String** |  | 
